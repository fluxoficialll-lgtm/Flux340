...
import socketPkg from './backend/config/socket.js';
const { initSocket } = socketPkg;
import middlewarePkg from './backend/config/middleware.js';
const { setupMiddlewares } = middlewarePkg;
import storagePkg from './backend/config/storage.js';
const { upload } = storagePkg;
import dbPkg from './backend/database/InicializacaoDoPostgreSQL.js';
const { db } = dbPkg;
import apiRoutes from './backend/RotasBackend/Rotas.js';
import pkg from './backend/database/AuditoresDeBancos/AuditorDoPostgreSQL.js';
const { auditorDoPostgreSQL } = pkg;
