...
const PaginaRankingSeguidores = lazy(() => import('../Paginas/PaginaRankingSeguidores').then(m => ({ default: m.PaginaRankingSeguidores })));
...
export const profileRoutes = [
  ...
  { path: '/ranking-followers', element: <ProtectedRoute><PaginaRankingSeguidores /></ProtectedRoute> }
];
