...
router.post('/create-session', async (req, res) => {
    ...
    try {
        ...
        // O e-mail do proprietário deve ser obtido de forma segura, por exemplo, do objeto req.user
...
router.post('/check-status', async (req, res) => {
    ...
    try {
        ...
        // O e-mail do proprietário deve vir do usuário autenticado para segurança
        const ownerEmail = req.user.email; 
