...
/**
 * ROTA INTERMEDIÁRIA: Marketplace / Crescimento
 * Resolve: /api/admin/execute/marketplace/growth
 */
...
export default async (req, res) => {
    try {
        ...
        const response = await fetch(`${coreUrl.replace(/\/$/, '')}/v1/admin/marketplace/stats`, {
            method: 'GET',
            headers: {
