...
/**
 * ROTA INTERMEDIÁRIA: Vendedores / Crescimento
 * Resolve: /api/admin/execute/sellers/growth
 */
...
export default async (req, res) => {
    try {
        ...
        const response = await fetch(`${coreUrl.replace(/\/$/, '')}/v1/admin/sellers/growth-stats`, {
            method: 'GET',
            headers: {
