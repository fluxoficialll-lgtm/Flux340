...
/**
 * ROTA INTERMEDIÁRIA: Afiliados / Crescimento
 * Resolve: /api/admin/execute/affiliates/growth
 */
...
export default async (req, res) => {
    try {
        ...
        const response = await fetch(`${coreUrl.replace(/\/$/, '')}/v1/admin/affiliates/growth-stats`, {
            method: 'GET',
            headers: {
